...
export function AdoptPage() {
  ...
  return (
    <div>
      <h1 style={{ fontSize: 21, margin: '0 0 4px' }}>Adopt global skills into the hub</h1>
      <p style={{ color: 'var(--text-muted)', marginTop: 0, maxWidth: 760 }}>
        {`Each adopted skill moves into ${plan.hubPath} and every agent directory that held a copy gets a symlink pointing there. Duplicate copies are preserved under the hub's .adopt-backup directory, never deleted. Only global skills are touched. Project skills stay where they are.`}
      </p>
